...
export default {
  ...
  setup() {
    ...
    return {
      ...
      async addList() {
        try {
          boardService.add('lists', { title: state.newList, position: this.lists.length, parentId: this.b.id })
        } catch (error) {
...
.text-shadow {
    ...
    text-shadow: $dark-transparent .2rem 0rem 5px, $dark-transparent -.2rem 0rem 5px, $dark-transparent 0rem .2rem 5px, $dark-transparent 0rem -.2rem 5px;
